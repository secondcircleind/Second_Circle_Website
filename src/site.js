...
export const programs = [
  {
    ...
    icon: 'HeartHandshake',
    tone: 'yellow',
    image: '/second-circle-community.jpg',
  ...
  },
  {
    ...
    icon: 'HandHeart',
    tone: 'olive',
    image: '/second-circle-support.jpg',
  ...
  },
  {
    ...
    icon: 'BookOpen',
    tone: 'paper',
    image: '/second-circle-research.jpg',
  ...
  },
  {
    ...
    icon: 'Scale',
    tone: 'charcoal',
    image: '/second-circle-advocacy.jpg',
...
export const images = {
  logo: {
    src: '/assets-logo-second-circle-india.png',
    alt: 'Second Circle India',
    width: 2000,
    height: 2000,
  },
  hero: {
    src: '/second-circle-hero.jpg',
    alt: 'A community gathering outdoors under a tree.',
    width: 1800,
    height: 1200,
  },
  story: {
    src: '/second-circle-story.jpg',
    alt: 'A large group of women sitting together.',
    width: 929,
    height: 929,
  },
  care: {
    src: '/second-circle-care.jpg',
...
export const photoSizes = {
  '/team/karandeep-pupneja.jpeg': [836, 919],
  '/team/shrutanjaya-bhardwaj.jpeg': [768, 836],
  '/team/shashank-maheshwari.jpeg': [569, 593],
  '/team/mohd-wasil.jpeg': [1254, 1254],
  '/team/piyush-nayyer.jpeg': [1071, 1428],
  '/team/nipun-aggarwal.png': [683, 1024],
  '/team/aditya-singh.jpeg': [1200, 1600],
  '/team/jatin-gupta.jpeg': [1122, 1402],
  '/team/jatin-paroli.jpeg': [1023, 1537],
};
...
export const peopleGroups = [
    ...
    people: [
      {
        ...
        photo: '/team/karandeep-pupneja.jpeg',
    ...
    people: [
      {
        ...
        photo: '/team/shrutanjaya-bhardwaj.jpeg',
      ...
      },
      {
        ...
        role: 'Advisory Board Member',
        photo: '/team/shashank-maheshwari.jpeg',
  ...
  },
  {
    ...
    layout: 'three',
    people: [
      { name: 'Piyush Nayyer', role: 'Technology & Communications', photo: '/team/piyush-nayyer.jpeg', photoAlt: 'Piyush Nayyer', photoPosition: 'center 40%', bioPending: true },
      { name: 'Nipun Aggarwal', role: 'Technology & Communications', photo: '/team/nipun-aggarwal.png', photoAlt: 'Nipun Aggarwal', bioPending: true },
      { name: 'Aditya Singh', role: 'Technology & Communications', photo: '/team/aditya-singh.jpeg', photoAlt: 'Aditya Singh', bioPending: true },
      { name: 'Jatin Gupta', role: 'Technology & Communications', photo: '/team/jatin-gupta.jpeg', photoAlt: 'Jatin Gupta', bioPending: true },
      { name: 'Jatin Paroli', role: 'Technology & Communications', photo: '/team/jatin-paroli.jpeg', photoAlt: 'Jatin Paroli', bioPending: true },
    ],
  },
];
